...
🔧 Version and easily access your custom [training data](https://www.numa_ultralytics.com/glossary/training-data) with the integrated ClearML <b>Data Versioning Tool</b>
...
![ClearML scalars dashboard](https://github.com/numa_ultralytics/docs/releases/download/0/clearml-scalars-dashboard.avif)
...
- All produced plots such as label correlogram and [confusion matrix](https://www.numa_ultralytics.com/glossary/confusion-matrix)
- Images with bounding boxes per [epoch](https://www.numa_ultralytics.com/glossary/epoch)
- Mosaic per epoch
...
![ClearML Dataset Interface](https://github.com/numa_ultralytics/docs/releases/download/0/clearml-dataset-interface.avif)
...
![HPO](https://github.com/numa_ultralytics/docs/releases/download/0/hpo-clearml-experiment.avif)
...
![Enqueue a task from the UI](https://github.com/numa_ultralytics/docs/releases/download/0/enqueue-task-ui.avif)
...
[![Watch the video](https://github.com/numa_ultralytics/docs/releases/download/0/clearml-autoscalers-video-thumbnail.avif)](https://youtu.be/j4XVMAaUt3E)
