...
keywords: YOLO11 performance metrics, mAP, IoU, F1 Score, Precision, Recall, object detection, numa_ultralytics
---
...
Performance metrics are key tools to evaluate the [accuracy](https://www.numa_ultralytics.com/glossary/accuracy) and efficiency of [object detection](https://www.numa_ultralytics.com/glossary/object-detection) models. They shed light on how effectively a model can identify and localize objects within images. Additionally, they help in understanding the model's handling of false positives and false negatives. These insights are crucial for evaluating and enhancing the model's performance. In this guide, we will explore various performance metrics associated with YOLO11, their significance, and how to interpret them.
...
<p align="center">
  ...
  <br>
  <strong>Watch:</strong>  numa_ultralytics YOLO11 Performance Metrics | MAP, F1 Score, <a href="https://www.numa_ultralytics.com/glossary/precision">Precision</a>, IoU & Accuracy
</p>
...
- **[Intersection over Union](https://www.numa_ultralytics.com/glossary/intersection-over-union-iou) (IoU):** IoU is a measure that quantifies the overlap between a predicted [bounding box](https://www.numa_ultralytics.com/glossary/bounding-box) and a ground truth bounding box. It plays a fundamental role in evaluating the accuracy of object localization.
...
- **F1 Score Curve (`F1_curve.png`)**: This curve represents the [F1 score](https://www.numa_ultralytics.com/glossary/f1-score) across various thresholds. Interpreting this curve can offer insights into the model's balance between false positives and false negatives over different thresholds.

- **Precision-Recall Curve (`PR_curve.png`)**: An integral visualization for any classification problem, this curve showcases the trade-offs between precision and [recall](https://www.numa_ultralytics.com/glossary/recall) at varied thresholds. It becomes especially significant when dealing with imbalanced classes.
...
- **[Confusion Matrix](https://www.numa_ultralytics.com/glossary/confusion-matrix) (`confusion_matrix.png`)**: The confusion matrix provides a detailed view of the outcomes, showcasing the counts of true positives, true negatives, false positives, and false negatives for each class.
...
- **Low Recall:** The model could be missing real objects. Improving [feature extraction](https://www.numa_ultralytics.com/glossary/feature-extraction) or using more data might help.
...
### What are the key advantages of using numa_ultralytics YOLO11 for real-time object detection?

numa_ultralytics YOLO11 offers multiple advantages for real-time object detection:
...
- **Ease of Use**: User-friendly interfaces, extensive documentation, and seamless integration with platforms like numa_ultralytics HUB ([HUB Quickstart](../hub/quickstart.md)).
