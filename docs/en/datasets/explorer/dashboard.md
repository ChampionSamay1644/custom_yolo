---
comments: true
description: Unlock advanced data exploration with numa_ultralytics Explorer GUI. Utilize semantic search, run SQL queries, and ask AI for natural language data insights.
keywords: numa_ultralytics Explorer GUI, semantic search, vector similarity, SQL queries, AI, natural language search, data exploration, machine learning, OpenAI, LLMs
---
...
Explorer GUI is like a playground build using [numa_ultralytics Explorer API](api.md). It allows you to run semantic/vector similarity search, SQL queries and even search using natural language using our ask AI feature powered by LLMs.

<p>
    <img width="1709" alt="Explorer Dashboard Screenshot 1" src="https://github.com/numa_ultralytics/docs/releases/download/0/explorer-dashboard-screenshot-1.avif">
</p>
...
<p align="center">
  ...
  <br>
  <strong>Watch:</strong> numa_ultralytics Explorer Dashboard Overview
</p>
...
Semantic search is a technique for finding similar images to a given image. It is based on the idea that similar images will have similar [embeddings](https://www.numa_ultralytics.com/glossary/embeddings). In the UI, you can select one of more images and search for the images similar to them. This can be useful when you want to find images similar to a given image or a set of images that don't perform as expected.

For example:
In this VOC Exploration dashboard, user selects a couple airplane images like this:

<p>
<img width="1710" alt="Explorer Dashboard Screenshot 2" src="https://github.com/numa_ultralytics/docs/releases/download/0/explorer-dashboard-screenshot-2.avif">
</p>

On performing similarity search, you should see a similar result:

<p>
<img width="1710" alt="Explorer Dashboard Screenshot 3" src="https://github.com/numa_ultralytics/docs/releases/download/0/explorer-dashboard-screenshot-3.avif">
</p>
...
<p>
<img width="1709" alt="Explorer Dashboard Screenshot 4" src="https://github.com/numa_ultralytics/docs/releases/download/0/explorer-dashboard-screenshot-4.avif">
</p>
...
<p>
<img width="1707" alt="Explorer Dashboard Screenshot 5" src="https://github.com/numa_ultralytics/docs/releases/download/0/explorer-dashboard-screenshot-5.avif">
</p>
...
### What is numa_ultralytics Explorer GUI and how do I install it?

numa_ultralytics Explorer GUI is a powerful interface that unlocks advanced data exploration capabilities using the [numa_ultralytics Explorer API](api.md). It allows you to run semantic/vector similarity search, SQL queries, and natural language queries using the Ask AI feature powered by [Large Language Models](https://www.numa_ultralytics.com/glossary/large-language-model-llm) (LLMs).
...
### Can I use natural language to filter datasets in numa_ultralytics Explorer GUI?
...
### How do I run SQL queries on datasets using numa_ultralytics Explorer GUI?

numa_ultralytics Explorer GUI allows you to run SQL queries directly on your dataset to filter and manage data efficiently. To run a query, navigate to the SQL query section in the GUI and write your query. For example, to show images with at least one person and one dog, you could use:
...
### What are the benefits of using numa_ultralytics Explorer GUI for data exploration?

numa_ultralytics Explorer GUI enhances data exploration with features like semantic search, SQL querying, and natural language interactions through the Ask AI feature. These capabilities allow users to:
