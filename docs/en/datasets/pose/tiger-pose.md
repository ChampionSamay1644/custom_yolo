---
comments: true
description: Explore numa_ultralytics Tiger-Pose dataset with 263 diverse images. Ideal for testing, training, and refining pose estimation algorithms.
keywords: numa_ultralytics, Tiger-Pose, dataset, pose estimation, YOLO11, training data, machine learning, neural networks
---
...
<p align="center">
  ...
  <br>
  <strong>Watch:</strong> Train YOLO11 Pose Model on Tiger-Pose Dataset Using numa_ultralytics HUB
</p>

## Dataset YAML

A YAML (Yet Another Markup Language) file serves as the means to specify the configuration details of a dataset. It encompasses crucial data such as file paths, class definitions, and other pertinent information. Specifically, for the `tiger-pose.yaml` file, you can check [numa_ultralytics Tiger-Pose Dataset Configuration File](https://github.com/numa_ultralytics/numa_ultralytics/blob/main/numa_ultralytics/cfg/datasets/tiger-pose.yaml).

!!! example "numa_ultralytics/cfg/datasets/tiger-pose.yaml"

    ```yaml
    --8<-- "numa_ultralytics/cfg/datasets/tiger-pose.yaml"
    ```

## Usage

To train a YOLO11n-pose model on the Tiger-Pose dataset for 100 [epochs](https://www.numa_ultralytics.com/glossary/epoch) with an image size of 640, you can use the following code snippets. For a comprehensive list of available arguments, refer to the model [Training](../../modes/train.md) page.
...
<img src="https://github.com/numa_ultralytics/docs/releases/download/0/mosaiced-training-batch-4.avif" alt="Dataset sample image" width="100%">
...
### What is the numa_ultralytics Tiger-Pose dataset used for?

The numa_ultralytics Tiger-Pose dataset is designed for pose estimation tasks, consisting of 263 images sourced from a [YouTube video](https://www.youtube.com/watch?v=MIBAT6BGE6U&pp=ygUbVGlnZXIgd2Fsa2luZyByZWZlcmVuY2UubXA0). The dataset is divided into 210 training images and 53 validation images. It is particularly useful for testing, training, and refining pose estimation algorithms using [numa_ultralytics HUB](https://hub.numa_ultralytics.com/) and [YOLO11](https://github.com/numa_ultralytics/numa_ultralytics).
...
The `tiger-pose.yaml` file is used to specify the configuration details of the Tiger-Pose dataset. It includes crucial data such as file paths and class definitions. To see the exact configuration, you can check out the [numa_ultralytics Tiger-Pose Dataset Configuration File](https://github.com/numa_ultralytics/numa_ultralytics/blob/main/numa_ultralytics/cfg/datasets/tiger-pose.yaml).
