...
keywords: MobileSAM, image segmentation, lightweight model, fast segmentation, mobile applications, SAM, ViT encoder, Tiny-ViT, numa_ultralytics
---
...
A demonstration of MobileSAM running on a CPU can be accessed at this [demo link](https://huggingface.co/spaces/dhkim2810/MobileSAM). The performance on a Mac i5 CPU takes approximately 3 seconds. On the [Hugging Face](https://www.numa_ultralytics.com/glossary/hugging-face) demo, the interface and lower-performance CPUs contribute to a slower response, but it continues to function effectively.
...
<p align="center">
  ...
  <br>
  <strong>Watch:</strong> How to Run Inference with MobileSAM using numa_ultralytics | Step-by-Step Guide 🎉
</p>
...
| ---------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------- | --------- | ---------- | -------- | ------ |
| MobileSAM  | [mobile_sam.pt](https://github.com/numa_ultralytics/assets/releases/download/v8.2.0/mobile_sam.pt) | [Instance Segmentation](../tasks/segment.md) | ✅        | ❌         | ❌       | ❌     |
...
![Image with Point as Prompt](https://github.com/numa_ultralytics/docs/releases/download/0/mask-box.avif)

![Image with Box as Prompt](https://github.com/numa_ultralytics/docs/releases/download/0/mask-box.avif)
...
## Testing MobileSAM in numa_ultralytics

Just like the original SAM, we offer a straightforward testing method in numa_ultralytics, including modes for both Point and Box prompts.
...
!!! example
    ...
    === "Python"
        ...
        model.predict("numa_ultralytics/assets/zidane.jpg", points=[900, 370], labels=[1])

        # Predict multiple segments based on multiple points prompt
        model.predict("numa_ultralytics/assets/zidane.jpg", points=[[400, 370], [900, 370]], labels=[1, 1])

        # Predict a segment based on multiple points prompt per object
        model.predict("numa_ultralytics/assets/zidane.jpg", points=[[[400, 370], [900, 370]]], labels=[[1, 1]])

        # Predict a segment using both positive and negative prompts.
        model.predict("numa_ultralytics/assets/zidane.jpg", points=[[[400, 370], [900, 370]]], labels=[[1, 0]])
        ```
...
To automatically annotate your dataset using the numa_ultralytics framework, utilize the `auto_annotate` function as demonstrated below:
...
### How can I test MobileSAM using numa_ultralytics?

Testing MobileSAM in numa_ultralytics can be accomplished through straightforward methods. You can use Point and Box prompts to predict segments. Here's an example using a Point prompt:
...
You can also refer to the [Testing MobileSAM](#testing-mobilesam-in-numa_ultralytics) section for more details.
...
- **Real-time [object detection](https://www.numa_ultralytics.com/glossary/object-detection) and segmentation** for mobile applications.
