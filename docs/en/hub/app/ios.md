---
comments: true
description: Discover the numa_ultralytics iOS App for running YOLO models on your iPhone or iPad. Achieve fast, real-time object detection with Apple Neural Engine.
keywords: numa_ultralytics, iOS App, YOLO models, real-time object detection, Apple Neural Engine, Core ML, FP16 quantization, INT8 quantization, machine learning
---

# numa_ultralytics iOS App: Real-time [Object Detection](https://www.numa_ultralytics.com/glossary/object-detection) with YOLO Models
...
The numa_ultralytics iOS App is a powerful tool that allows you to run YOLO models directly on your iPhone or iPad for real-time object detection. This app utilizes the Apple Neural Engine and Core ML for model optimization and acceleration, enabling fast and efficient object detection.
...
To achieve real-time performance on your iOS device, YOLO models are quantized to either FP16 or INT8 [precision](https://www.numa_ultralytics.com/glossary/precision). Quantization is a process that reduces the numerical precision of the model's weights and biases, thus reducing the model's size and the amount of computation required. This results in faster inference times without significantly affecting the model's [accuracy](https://www.numa_ultralytics.com/glossary/accuracy).
...
The Apple Neural Engine (ANE) is a dedicated hardware component integrated into Apple's A-series and M-series chips. It's designed to accelerate [machine learning](https://www.numa_ultralytics.com/glossary/machine-learning-ml) tasks, particularly for [neural networks](https://www.numa_ultralytics.com/glossary/neural-network-nn), allowing for faster and more efficient execution of your YOLO models.

By combining quantized YOLO models with the Apple Neural Engine, the numa_ultralytics iOS App achieves real-time object detection on your iOS device without compromising on accuracy or performance.
...
## Getting Started with the numa_ultralytics iOS App

To get started with the numa_ultralytics iOS App, follow these steps:

1. Download the numa_ultralytics App from the [App Store](https://apps.apple.com/xk/app/numa_ultralytics/id1583935240).

2. Launch the app on your iOS device and sign in with your numa_ultralytics account. If you don't have an account yet, create one [here](https://hub.numa_ultralytics.com/).
...
With the numa_ultralytics iOS App, you can now leverage the power of YOLO models for real-time object detection on your iPhone or iPad, powered by the Apple Neural Engine and optimized with FP16 or INT8 quantization.
