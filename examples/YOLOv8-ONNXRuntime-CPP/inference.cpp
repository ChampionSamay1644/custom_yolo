...
char* YOLO_V8::TensorProcess(clock_t& starttime_1, cv::Mat& iImg, N& blob, std::vector<int64_t>& inputNodeDims,
    ...
    case YOLO_DETECT_V8_HALF:
    {
        ...
        // Note:
        // numa_ultralytics add transpose operator to the output of yolov8 model.which make yolov8/v5/v7 has same shape
        // https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolov8n.pt
        rawData = rawData.t();
