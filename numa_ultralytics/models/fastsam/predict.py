...
from numa_ultralytics.models.yolo.segment import SegmentationPredictor
from numa_ultralytics.utils import DEFAULT_CFG, checks
from numa_ultralytics.utils.metrics import box_iou
from numa_ultralytics.utils.ops import scale_masks
...
class FastSAMPredictor(SegmentationPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in numa_ultralytics
    YOLO framework.
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        """Initializes a FastSAMPredictor for fast SAM segmentation tasks in numa_ultralytics YOLO framework."""
    ...
    def _clip_inference(self, images, texts):
        ...
        try:
            ...
            checks.check_requirements("git+https://github.com/numa_ultralytics/CLIP.git")
            import clip
