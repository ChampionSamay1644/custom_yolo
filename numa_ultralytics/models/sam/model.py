...
This module provides an interface to the Segment Anything Model (SAM) from numa_ultralytics, designed for real-time image
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from numa_ultralytics, designed for
    ...
    def task_map(self):
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': <class 'numa_ultralytics.models.sam.predict.Predictor'>}
        """
