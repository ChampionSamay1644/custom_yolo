...
using SAM. It forms an integral part of the numa_ultralytics framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from numa_ultralytics.engine.predictor import BasePredictor
from numa_ultralytics.engine.results import Results
from numa_ultralytics.utils import DEFAULT_CFG, ops
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model=None, verbose=True):
        ...
        parameters for image normalization and other numa_ultralytics compatibility settings.
        ...
        # numa_ultralytics compatibility settings
        self.model.pt = False
