...
from numa_ultralytics.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding numa_ultralytics classes.

        Returns:
            dict: A dictionary mapping task names to numa_ultralytics task classes for the RT-DETR model.
        """
        return {
            "detect": {
