...
from numa_ultralytics.data.augment import Compose, Format, v8_transforms
from numa_ultralytics.models.yolo.detect import DetectionValidator
from numa_ultralytics.utils import colorstr, ops
...
class RTDETRValidator(DetectionValidator):
    ...
    Example:
        ```python
        from numa_ultralytics.models.rtdetr import RTDETRValidator
