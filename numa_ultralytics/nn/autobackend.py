...
from numa_ultralytics.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from numa_ultralytics.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from numa_ultralytics.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    """
    Handles dynamic backend selection for running inference using numa_ultralytics YOLO models.
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from numa_ultralytics.nn.tasks import attempt_load_weights
        ...
        # TensorRT
            ...
            with open(w, "rb") as f, trt.Runtime(logger) as runtime:
                try:
                    ...
                    f.seek(0)  # engine file may lack embedded numa_ultralytics metadata
        ...
        # TF GraphDef
            ...
            from numa_ultralytics.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from numa_ultralytics.utils.triton import TritonRemoteModel
        ...
        # Any other format (unsupported)
            ...
            from numa_ultralytics.engine.exporter import export_formats

            raise TypeError(
                f"model='{w}' is not a supported model format. numa_ultralytics supports: {export_formats()['Format']}\n"
                f"See https://docs.numa_ultralytics.com/modes/predict for help."
            )
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        # CoreML
            ...
            if "confidence" in y:
                raise TypeError(
                    "numa_ultralytics only supports inference of non-pipelined CoreML models exported with "
                    f"'nms=False', but 'model={w}' has an NMS pipeline created by an 'nms=True' export."
                )
                # TODO: CoreML NMS inference handling
                # from numa_ultralytics.utils.ops import xywh2xyxy
            ...
            if self.saved_model:  # SavedModel
                ...
                for output in self.output_details:
                    ...
                    if x.ndim == 3:  # if task is not classification, excluding masks (ndim=4) as well
                        # Denormalize xywh by image size. See https://github.com/numa_ultralytics/numa_ultralytics/pull/1695
