...
from numa_ultralytics.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from numa_ultralytics.utils.checks import check_font, check_version, is_ascii
from numa_ultralytics.utils.files import increment_path


class Colors:
    """
    numa_ultralytics color palette https://docs.numa_ultralytics.com/reference/utils/plotting/#numa_ultralytics.utils.plotting.Colors.

    This class provides methods to work with the numa_ultralytics color palette, including converting hex color codes to
    RGB values.
    ...
    Examples:
        >>> from numa_ultralytics.utils.plotting import Colors
        >>> color = Colors(5, True)  # ff6fdd or (255, 111, 221)

    ## numa_ultralytics Color Palette
    ...
    !!! note "numa_ultralytics Brand Colors"

        For numa_ultralytics brand colors see [https://www.numa_ultralytics.com/brand](https://www.numa_ultralytics.com/brand). Please use the official numa_ultralytics colors for all marketing materials.
    """
...
class Annotator:
    """
    numa_ultralytics Annotator for train/val mosaics and JPGs and predictions annotations.
...
@TryExcept()  # known issue https://github.com/numa_ultralytics/yolov5/issues/5395
@plt_settings()
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    """Plot training labels including class histograms and box statistics."""
    import pandas  # scope for faster 'import numa_ultralytics'
    import seaborn  # scope for faster 'import numa_ultralytics'
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from numa_ultralytics.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/numa_ultralytics/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ...
        ```
    """
    import pandas as pd  # scope for faster 'import numa_ultralytics'
