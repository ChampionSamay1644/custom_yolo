...
def spaces_in_path(path):
    ...
    Examples:
        ...
        >>> from numa_ultralytics.utils.files import spaces_in_path
...
def update_models(model_names=("yolo11n.pt",), source_dir=Path("."), update_names=False):
    ...
    Examples:
        ...
        >>> from numa_ultralytics.utils.files import update_models
        >>> model_names = ("yolo11n.pt", "yolov8s.pt")
        >>> update_models(model_names, source_dir=Path("/models"), update_names=True)
    """
    from numa_ultralytics import YOLO
    from numa_ultralytics.nn.autobackend import default_class_names
