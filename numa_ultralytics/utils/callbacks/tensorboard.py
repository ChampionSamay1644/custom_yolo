...
from numa_ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/numa_ultralytics/numa_ultralytics/pull/4674
    ...
    from numa_ultralytics.utils.torch_utils import de_parallel, torch
