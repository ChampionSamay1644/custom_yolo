...
from numa_ultralytics.utils import LOGGER, SimpleClass, TryExcept, plt_settings
...
def smooth_bce(eps=0.1):
    ...
    For implementation details, refer to https://github.com/numa_ultralytics/yolov3/issues/238#issuecomment-598028441.
