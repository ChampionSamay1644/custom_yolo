...
from numa_ultralytics.utils.metrics import batch_probiou
...
def segment2box(segment, width=640, height=640):
    ...
    # any 3 out of 4 sides are outside the image, clip coordinates first, https://github.com/numa_ultralytics/numa_ultralytics/pull/18294
...
def masks2segments(masks, strategy="all"):
    ...
    """
    from numa_ultralytics.data.converter import merge_multi_segment
