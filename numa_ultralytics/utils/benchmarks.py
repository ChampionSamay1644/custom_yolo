...
Usage:
    from numa_ultralytics.utils.benchmarks import ProfileModels, benchmark
...
from numa_ultralytics import YOLO, YOLOWorld
from numa_ultralytics.cfg import TASK2DATA, TASK2METRIC
from numa_ultralytics.engine.exporter import export_formats
from numa_ultralytics.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from numa_ultralytics.utils.checks import IS_PYTHON_3_12, check_imgsz, check_requirements, check_yolo, is_rockchip
from numa_ultralytics.utils.downloads import safe_download
from numa_ultralytics.utils.files import file_size
from numa_ultralytics.utils.torch_utils import get_cpu_info, select_device
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt="datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("numa_ultralytics-benchmarks")
        safe_download("https://github.com/numa_ultralytics/assets/releases/download/v0.0.0/datasets_links.txt")
