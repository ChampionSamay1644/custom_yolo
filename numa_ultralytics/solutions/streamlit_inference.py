...
from numa_ultralytics.utils import LOGGER
from numa_ultralytics.utils.checks import check_requirements
from numa_ultralytics.utils.downloads import GITHUB_ASSETS_STEMS


class Inference:
    """
    A class to perform object detection, image classification, image segmentation and pose estimation inference using
    Streamlit and numa_ultralytics YOLO models. It provides the functionalities such as loading models, configuring settings,
    ...
    def __init__(self, **kwargs: Any):
        ...
        """
        check_requirements("streamlit>=1.29.0")  # scope imports for faster numa_ultralytics package load speeds
        ...
        LOGGER.info(f"numa_ultralytics Solutions: ✅ {self.temp_dict}")
    ...
    def web_ui(self):
        ...
        font-family: 'Archivo', sans-serif; margin-bottom:20px;">numa_ultralytics YOLO Streamlit Application</h1></div>"""

        # Subtitle of streamlit application
        sub_title_cfg = """<div><h4 style="color:#042AFF; text-align:center; font-family: 'Archivo', sans-serif; 
        margin-top:-15px; margin-bottom:50px;">Experience real-time object detection on your webcam with the power 
        of numa_ultralytics YOLO! 🚀</h4></div>"""

        # Set html page configuration and append custom HTML
        self.st.set_page_config(page_title="numa_ultralytics Streamlit App", layout="wide")
    ...
    def sidebar(self):
        ...
        with self.st.sidebar:  # Add numa_ultralytics LOGO
            logo = "https://raw.githubusercontent.com/numa_ultralytics/assets/main/logo/numa_ultralytics_Logotype_Original.svg"
    ...
    def source_upload(self):
        ...
        if self.source == "video":
            ...
            if vid_file is not None:
                ...
                with open("numa_ultralytics.mp4", "wb") as out:  # Open temporary file as bytes
                    out.write(g.read())  # Read bytes into file
                self.vid_file_name = "numa_ultralytics.mp4"
