...
from numa_ultralytics.solutions.object_counter import ObjectCounter
...
class Heatmap(ObjectCounter):
    ...
    Examples:
        >>> from numa_ultralytics.solutions import Heatmap
    ...
    def generate_heatmap(self, im0):
        """
        Generate heatmap for each frame using numa_ultralytics.
