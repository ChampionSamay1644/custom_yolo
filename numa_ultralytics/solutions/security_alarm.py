...
from numa_ultralytics.solutions.solutions import BaseSolution
...
class SecurityAlarm(BaseSolution):
    ...
    def send_email(self, im0, records=5):
        ...
        message_body = f"numa_ultralytics ALERT!!! {records} objects have been detected!!"
        message.attach(MIMEText(message_body))

        # Attach the image
        image_attachment = MIMEImage(img_bytes, name="numa_ultralytics.jpg")
