...
from numa_ultralytics.data.utils import polygons2masks, polygons2masks_overlap
from numa_ultralytics.utils import LOGGER, colorstr
from numa_ultralytics.utils.checks import check_version
from numa_ultralytics.utils.instance import Instances
from numa_ultralytics.utils.metrics import bbox_ioa
from numa_ultralytics.utils.ops import segment2box, xyxyxyxy2xywhr
from numa_ultralytics.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class BaseTransform:
    """
    Base class for image transformations in the numa_ultralytics library.
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from numa_ultralytics.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from numa_ultralytics.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from numa_ultralytics.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        ...
        values and labels. This implementation is designed for use with the numa_ultralytics YOLO framework.
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from numa_ultralytics.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        if self.hgain or self.sgain or self.vgain:
            ...
            # Original implementation (bug) from numa_ultralytics<=8.3.78
            ...
            # Fixed implementation in https://github.com/numa_ultralytics/numa_ultralytics/pull/19311
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (numa_ultralytics.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (numa_ultralytics.utils.instance.Instances): Updated instances matching the flipped image.
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from numa_ultralytics.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from numa_ultralytics.data.dataset import YOLODataset
        >>> from numa_ultralytics.utils import IterableSimpleNamespace
...
def classify_transforms(
    ...
    """
    import torchvision.transforms as T  # scope for faster 'import numa_ultralytics'
...
class ToTensor:
    ...
    def __init__(self, half=False):
        ...
        numa_ultralytics YOLO framework. It converts numpy arrays or PIL Images to PyTorch tensors, with an option
