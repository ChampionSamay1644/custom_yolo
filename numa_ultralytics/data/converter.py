...
from numa_ultralytics.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    for mask_path in Path(masks_dir).iterdir():
        if mask_path.suffix in {".png", ".jpg"}:
            ...
            # Save numa_ultralytics YOLO format data to file
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from numa_ultralytics.data.converter import create_synthetic_coco_dataset
