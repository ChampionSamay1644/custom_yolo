...
from numa_ultralytics.data.utils import FORMATS_HELP_MSG, HELP_URL, IMG_FORMATS
from numa_ultralytics.utils import DEFAULT_CFG, LOCAL_RANK, LOGGER, NUM_THREADS, TQDM
...
class BaseDataset(Dataset):
    ...
    def get_image_and_label(self, index):
        ...
        label = deepcopy(self.labels[index])  # requires deepcopy() https://github.com/numa_ultralytics/numa_ultralytics/pull/1948
