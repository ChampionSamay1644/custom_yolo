...
from numa_ultralytics.utils.checks import check_file, check_font, is_ascii
from numa_ultralytics.utils.downloads import download, safe_download, unzip_file
from numa_ultralytics.utils.ops import segments2boxes

HELP_URL = "See https://docs.numa_ultralytics.com/datasets for dataset formatting guidance."
...
def check_cls_dataset(dataset, split=""):
    ...
    if not data_dir.is_dir():
        ...
        if str(dataset) == "imagenet":
            ...
            url = f"https://github.com/numa_ultralytics/assets/releases/download/v0.0.0/{dataset}.zip"
...
class HUBDatasetStats:
    ...
    Example:
        Download *.zip files from https://github.com/numa_ultralytics/hub/tree/main/example_datasets
            i.e. https://github.com/numa_ultralytics/hub/raw/main/example_datasets/coco8.zip for coco8.zip.
        ```python
        from numa_ultralytics.data.utils import HUBDatasetStats
    ...
    def get_json(self, save=False, verbose=False):
        """Return dataset JSON for numa_ultralytics HUB."""
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                from torchvision.datasets import ImageFolder  # scope for faster 'import numa_ultralytics'
                ...
                from numa_ultralytics.data import YOLODataset
    ...
    def process_images(self):
        """Compress images for numa_ultralytics HUB."""
        from numa_ultralytics.data import YOLODataset  # ClassificationDataset
...
def load_dataset_cache_file(path):
    """Load an numa_ultralytics *.cache dictionary from path."""
    import gc

    gc.disable()  # reduce pickle load time https://github.com/numa_ultralytics/numa_ultralytics/pull/1585
...
def save_dataset_cache_file(prefix, path, x, version):
    """Save an numa_ultralytics dataset *.cache dictionary x to path."""
