...
"""
Module provides functionalities for hyperparameter tuning of the numa_ultralytics YOLO models for object detection, instance
...
from numa_ultralytics.utils import DEFAULT_CFG, LOGGER, callbacks, colorstr, remove_colorstr, yaml_print, yaml_save
from numa_ultralytics.utils.plotting import plot_tune_results
...
class Tuner:
    ...
    def __init__(self, args=DEFAULT_CFG, _callbacks=None):
        ...
        LOGGER.info(
            ...
            f"{self.prefix}💡 Learn about tuning at https://docs.numa_ultralytics.com/guides/hyperparameter-tuning"
        )
