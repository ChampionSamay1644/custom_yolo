...
"""
numa_ultralytics Results, Boxes and Masks classes for handling inference results.

Usage: See https://docs.numa_ultralytics.com/modes/predict/
"""
...
from numa_ultralytics.data.augment import LetterBox
from numa_ultralytics.utils import LOGGER, SimpleClass, ops
from numa_ultralytics.utils.checks import check_requirements
from numa_ultralytics.utils.plotting import Annotator, colors, save_one_box
from numa_ultralytics.utils.torch_utils import smart_inference_mode
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from numa_ultralytics.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Masks(BaseTensor):
    ...
    def __init__(self, masks, orig_shape) -> None:
        ...
        Examples:
            >>> import torch
            >>> from numa_ultralytics.engine.results import Masks
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from numa_ultralytics.engine.results import Keypoints
