...
from numa_ultralytics.cfg import TASK2DATA, get_cfg
from numa_ultralytics.data import build_dataloader
from numa_ultralytics.data.dataset import YOLODataset
from numa_ultralytics.data.utils import check_cls_dataset, check_det_dataset
from numa_ultralytics.nn.autobackend import check_class_names, default_class_names
from numa_ultralytics.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from numa_ultralytics.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
...
from numa_ultralytics.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from numa_ultralytics.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from numa_ultralytics.utils.files import file_size, spaces_in_path
from numa_ultralytics.utils.ops import Profile, nms_rotated, xywh2xyxy
from numa_ultralytics.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device


def export_formats():
    """numa_ultralytics YOLO export formats."""
    x = [
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/numa_ultralytics/numa_ultralytics/pull/13420
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.numa_ultralytics.com/models/yolo-world for details."
            )
            model.clip_model = None  # openvino int8 export error: https://github.com/numa_ultralytics/numa_ultralytics/pull/18445
        ...
        if imx:
            from numa_ultralytics.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from numa_ultralytics.utils.tal import make_anchors
        ...
        description = f"numa_ultralytics {self.pretty_name} model {f'trained on {data}' if data else ''}"
        self.metadata = {
            "description": description,
            "author": "numa_ultralytics",
    ...
    def export_engine(self, dla=None, prefix=colorstr("TensorRT:")):
        ...
        f_onnx, _ = self.export_onnx()  # run before TRT import https://github.com/numa_ultralytics/numa_ultralytics/issues/7016
        ...
        check_version(trt.__version__, "!=10.1.0", msg="https://github.com/numa_ultralytics/numa_ultralytics/pull/14239")
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # numa_ultralytics.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/numa_ultralytics/numa_ultralytics/issues/5161",
        )
        import onnx2tf
        ...
        keras_model = onnx2tf.convert(
            ...
            verbosity="error",  # note INT8-FP16 activation bug https://github.com/numa_ultralytics/numa_ultralytics/issues/15873
    ...
    def export_tflite(self, prefix=colorstr("TensorFlow Lite:")):
        ...
        # BUG https://github.com/numa_ultralytics/numa_ultralytics/issues/13436
        import tensorflow as tf  # noqa
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/numa_ultralytics/numa_ultralytics/issues/1185")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an numa_ultralytics YOLO model for Apple iOS CoreML export."""
