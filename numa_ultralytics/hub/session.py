...
from numa_ultralytics.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX, TQDM
from numa_ultralytics.utils import IS_COLAB, LOGGER, SETTINGS, __version__, checks, emojis
from numa_ultralytics.utils.errors import HUBModelError
...
class HUBTrainingSession:
    """
    HUB training session for numa_ultralytics HUB YOLO models. Handles model initialization, heartbeats, and checkpointing.

    Attributes:
        model_id (str): Identifier for the YOLO model being trained.
        model_url (str): URL for the model in numa_ultralytics HUB.
        rate_limits (dict): Rate limits for different API calls (in seconds).
        timers (dict): Timers for rate limiting.
        metrics_queue (dict): Queue for the model's metrics.
        model (dict): Model data fetched from numa_ultralytics HUB.
    """
    ...
    def __init__(self, identifier):
        ...
        self.timers = {}  # holds timers in numa_ultralytics/utils/callbacks/hub.py
        self.model = None
        self.model_url = None
        ...
        try:
            ...
            if identifier.startswith(f"{HUB_WEB_ROOT}/models/") and not self.client.authenticated:
                LOGGER.warning(
                    ...
                    "You can find your API Key at: https://hub.numa_ultralytics.com/settings?tab=api+keys."
                )
    ...
    def load_model(self, model_id):
        """Loads an existing model from numa_ultralytics HUB using the provided model identifier."""
    ...
    def _parse_identifier(identifier):
        ...
        The method supports different identifier formats:
            - A HUB model URL https://hub.numa_ultralytics.com/models/MODEL
            - A HUB model URL with API Key https://hub.numa_ultralytics.com/models/MODEL?api_key=APIKEY
    ...
    def _set_train_args(self):
        """
        Initializes training arguments and creates a model entry on the numa_ultralytics HUB.
    ...
    def upload_metrics(self):
        """Upload model metrics to numa_ultralytics HUB."""
    ...
    def upload_model(
        ...
        """
        Upload a model checkpoint to numa_ultralytics HUB.
        ...
        if not weights.is_file():
            ...
            if final and last.is_file():
                LOGGER.warning(
                    ...
                    "For more reliable training, consider using numa_ultralytics HUB Cloud. "
                    "Learn more at https://docs.numa_ultralytics.com/hub/cloud-training."
                )
