...
[numa_ultralytics](https://www.numa_ultralytics.com/) [YOLO11](https://github.com/numa_ultralytics/numa_ultralytics) 是一个尖端的、最先进（SOTA）的模型，基于之前 YOLO 版本的成功，并引入了新功能和改进以进一步提升性能和灵活性。YOLO11 被设计得快速、准确且易于使用，是进行广泛对象检测和跟踪、实例分割、图像分类和姿态估计任务的理想选择。

我们希望这里的资源能帮助你充分利用 YOLO。请浏览 numa_ultralytics <a href="https://docs.numa_ultralytics.com/">文档</a> 以获取详细信息，在 <a href="https://github.com/numa_ultralytics/numa_ultralytics/issues/new/choose">GitHub</a> 上提出问题或讨论，成为 numa_ultralytics <a href="https://discord.com/invite/numa_ultralytics">Discord</a>、<a href="https://reddit.com/r/numa_ultralytics">Reddit</a> 和 <a href="https://community.numa_ultralytics.com/">论坛</a> 的成员！

想申请企业许可证，请完成 [numa_ultralytics Licensing](https://www.numa_ultralytics.com/license) 上的表单。
...
请参阅下方的快速开始安装和使用示例，并查看我们的 [文档](https://docs.numa_ultralytics.com/) 以获取有关训练、验证、预测和部署的完整文档。

<details open>
<summary>安装</summary>

在 [**Python>=3.8**](https://www.python.org/) 环境中使用 [**PyTorch>=1.8**](https://pytorch.org/get-started/locally/) 通过 pip 安装包含所有[依赖项](https://github.com/numa_ultralytics/numa_ultralytics/blob/main/pyproject.toml) 的 numa_ultralytics 包。
...
有关其他安装方法，包括 [Conda](https://anaconda.org/conda-forge/numa_ultralytics)、[Docker](https://hub.docker.com/r/numa_ultralytics/numa_ultralytics) 和 Git，请参阅 [快速开始指南](https://docs.numa_ultralytics.com/quickstart/)。
...
`yolo` 可以用于各种任务和模式，并接受额外参数，例如 `imgsz=640`。请参阅 YOLO [CLI 文档](https://docs.numa_ultralytics.com/usage/cli/) 以获取示例。

### Python

YOLO 也可以直接在 Python 环境中使用，并接受与上述 CLI 示例中相同的[参数](https://docs.numa_ultralytics.com/usage/cfg/)：
...
请参阅 YOLO [Python 文档](https://docs.numa_ultralytics.com/usage/python/) 以获取更多示例。

</details>

## <div align="center">模型</div>

YOLO11 [检测](https://docs.numa_ultralytics.com/tasks/detect/)、[分割](https://docs.numa_ultralytics.com/tasks/segment/) 和 [姿态](https://docs.numa_ultralytics.com/tasks/pose/) 模型在 [COCO](https://docs.numa_ultralytics.com/datasets/detect/coco/) 数据集上进行预训练，这些模型可在此处获得，此外还有在 [ImageNet](https://docs.numa_ultralytics.com/datasets/classify/imagenet/) 数据集上预训练的 YOLO11 [分类](https://docs.numa_ultralytics.com/tasks/classify/) 模型。所有检测、分割和姿态模型均支持 [跟踪](https://docs.numa_ultralytics.com/modes/track/) 模式。所有[模型](https://docs.numa_ultralytics.com/models/)在首次使用时自动从最新的 numa_ultralytics [发布](https://github.com/numa_ultralytics/assets/releases)下载。

<a href="https://docs.numa_ultralytics.com/tasks/" target="_blank">
...
请参阅 [检测文档](https://docs.numa_ultralytics.com/tasks/detect/) 以获取使用这些在 [COCO](https://docs.numa_ultralytics.com/datasets/detect/coco/) 数据集上训练的模型的示例，其中包含 80 个预训练类别。
...
请参阅 [分割文档](https://docs.numa_ultralytics.com/tasks/segment/) 以获取使用这些在 [COCO-Seg](https://docs.numa_ultralytics.com/datasets/segment/coco/) 数据集上训练的模型的示例，其中包含 80 个预训练类别。
...
| ------------------------------------------------------------------------------------------------- | ------------------- | -------------------- | --------------------- | ----------------------------- | ---------------------------------- | ---------------- | ----------------- |
| [YOLO11n-seg](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11n-seg.pt) | 640                 | 38.9                 | 32.0                  | 65.9 ± 1.1                    | 1.8 ± 0.0                          | 2.9              | 10.4              |
| [YOLO11s-seg](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11s-seg.pt) | 640                 | 46.6                 | 37.8                  | 117.6 ± 4.9                   | 2.9 ± 0.0                          | 10.1             | 35.5              |
| [YOLO11m-seg](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11m-seg.pt) | 640                 | 51.5                 | 41.5                  | 281.6 ± 1.2                   | 6.3 ± 0.1                          | 22.4             | 123.3             |
| [YOLO11l-seg](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11l-seg.pt) | 640                 | 53.4                 | 42.9                  | 344.2 ± 3.2                   | 7.8 ± 0.2                          | 27.6             | 142.2             |
| [YOLO11x-seg](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11x-seg.pt) | 640                 | 54.7                 | 43.8                  | 664.5 ± 3.2                   | 15.8 ± 0.7                         | 62.1             | 319.0             |
...
请参阅 [分类文档](https://docs.numa_ultralytics.com/tasks/classify/) 以获取使用这些在 [ImageNet](https://docs.numa_ultralytics.com/datasets/classify/imagenet/) 数据集上训练的模型的示例，其中包含 1000 个预训练类别。
...
| ------------------------------------------------------------------------------------------------- | ------------------- | ---------------- | ---------------- | ----------------------------- | ---------------------------------- | ---------------- | ------------------------ |
| [YOLO11n-cls](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11n-cls.pt) | 224                 | 70.0             | 89.4             | 5.0 ± 0.3                     | 1.1 ± 0.0                          | 1.6              | 3.3                      |
| [YOLO11s-cls](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11s-cls.pt) | 224                 | 75.4             | 92.7             | 7.9 ± 0.2                     | 1.3 ± 0.0                          | 5.5              | 12.1                     |
| [YOLO11m-cls](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11m-cls.pt) | 224                 | 77.3             | 93.9             | 17.2 ± 0.4                    | 2.0 ± 0.0                          | 10.4             | 39.3                     |
| [YOLO11l-cls](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11l-cls.pt) | 224                 | 78.3             | 94.3             | 23.2 ± 0.3                    | 2.8 ± 0.0                          | 12.9             | 49.4                     |
| [YOLO11x-cls](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11x-cls.pt) | 224                 | 79.5             | 94.9             | 41.4 ± 0.9                    | 3.8 ± 0.0                          | 28.4             | 110.4                    |
...
请参阅 [姿态文档](https://docs.numa_ultralytics.com/tasks/pose/) 以获取使用这些在 [COCO-Pose](https://docs.numa_ultralytics.com/datasets/pose/coco/) 数据集上训练的模型的示例，其中包含 1 个预训练类别（人）。
...
| ------------------------------------------------------------------------------------------------- | ------------------- | --------------------- | ------------------ | ----------------------------- | ---------------------------------- | ---------------- | ----------------- |
| [YOLO11n-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11n-obb.pt) | 1024                | 78.4                  | 117.6 ± 0.8        | 4.4 ± 0.0                     | 2.7                                | 17.2             |
| [YOLO11s-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11s-obb.pt) | 1024                | 79.5                  | 219.4 ± 4.0        | 5.1 ± 0.0                     | 9.7                                | 57.5             |
| [YOLO11m-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11m-obb.pt) | 1024                | 80.9                  | 562.8 ± 2.9        | 10.1 ± 0.4                    | 20.9                               | 183.5            |
| [YOLO11l-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11l-obb.pt) | 1024                | 81.0                  | 712.5 ± 5.0        | 13.5 ± 0.6                    | 26.2                               | 232.0            |
| [YOLO11x-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11x-obb.pt) | 1024                | 81.3                  | 1408.6 ± 7.7       | 28.6 ± 1.0                    | 58.8                               | 520.2            |
...
请参阅 [OBB 文档](https://docs.numa_ultralytics.com/tasks/obb/) 以获取使用这些在 [DOTAv1](https://docs.numa_ultralytics.com/datasets/obb/dota-v2/#dota-v10/) 数据集上训练的模型的示例，其中包含 15 个预训练类别。

| 模型                                                                                              | 尺寸<br><sup>(像素) | mAP<sup>test<br>50 | 速度<br><sup>CPU ONNX<br>(ms) | 速度<br><sup>T4 TensorRT10<br>(ms) | 参数<br><sup>(M) | FLOPs<br><sup>(B) |
| ------------------------------------------------------------------------------------------------- | ------------------- | ------------------ | ----------------------------- | ---------------------------------- | ---------------- | ----------------- |
| [YOLO11n-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11n-obb.pt) | 1024                | 78.4               | 117.56 ± 0.80                 | 4.43 ± 0.01                        | 2.7              | 17.2              |
| [YOLO11s-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11s-obb.pt) | 1024                | 79.5               | 219.41 ± 4.00                 | 5.13 ± 0.02                        | 9.7              | 57.5              |
| [YOLO11m-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11m-obb.pt) | 1024                | 80.9               | 562.81 ± 2.87                 | 10.07 ± 0.38                       | 20.9             | 183.5             |
| [YOLO11l-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11l-obb.pt) | 1024                | 81.0               | 712.49 ± 4.98                 | 13.46 ± 0.55                       | 26.2             | 232.0             |
| [YOLO11x-obb](https://github.com/numa_ultralytics/assets/releases/download/v8.3.0/yolo11x-obb.pt) | 1024                | 81.3               | 1408.63 ± 7.67                | 28.59 ± 0.96                       | 58.8             | 520.2             |
...
我们与领先的 AI 平台的关键集成扩展了 numa_ultralytics 产品的功能，提升了数据集标注、训练、可视化和模型管理等任务。探索 numa_ultralytics 如何通过与 [W&B](https://docs.wandb.ai/guides/integrations/numa_ultralytics/)、[Comet](https://bit.ly/yolov8-readme-comet)、[Roboflow](https://roboflow.com/?ref=numa_ultralytics) 和 [OpenVINO](https://docs.numa_ultralytics.com/integrations/openvino/) 的合作，优化您的 AI 工作流程。
...
<div align="center">
  ...
  <a href="https://docs.wandb.ai/guides/integrations/numa_ultralytics/">
    <img src="https://github.com/numa_ultralytics/assets/raw/main/partners/logo-wb.png" width="10%" alt="W&B logo"></a>
  <img src="https://github.com/numa_ultralytics/assets/raw/main/social/logo-transparent.png" width="15%" height="0" alt="space">
...
|                                                numa_ultralytics HUB 🚀                                                 |                                                     W&B                                                     |                                                     Comet ⭐ 全新                                                      |                                            Neural Magic                                             |
| :--------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------: |
| 简化 YOLO 工作流程：通过 [numa_ultralytics HUB](https://www.numa_ultralytics.com/hub) 轻松标注、训练和部署。立即试用！ | 使用 [Weights & Biases](https://docs.wandb.ai/guides/integrations/numa_ultralytics/) 跟踪实验、超参数和结果 | 永久免费，[Comet](https://bit.ly/yolov5-readme-comet) 允许您保存 YOLO11 模型、恢复训练，并交互式地可视化和调试预测结果 | 使用 [Neural Magic DeepSparse](https://bit.ly/yolov5-neuralmagic) 运行 YOLO11 推理，速度提升至 6 倍 |

## <div align="center">numa_ultralytics HUB</div>

体验无缝 AI 使用 [numa_ultralytics HUB](https://www.numa_ultralytics.com/hub) ⭐，一个集数据可视化、YOLO11 🚀 模型训练和部署于一体的解决方案，无需编写代码。利用我们最先进的平台和用户友好的 [numa_ultralytics 应用](https://www.numa_ultralytics.com/app-install)，将图像转换为可操作见解，并轻松实现您的 AI 愿景。免费开始您的旅程！
...
我们欢迎您的意见！没有社区的帮助，numa_ultralytics YOLO 就不可能实现。请参阅我们的 [贡献指南](https://docs.numa_ultralytics.com/help/contributing/) 开始，并填写我们的 [调查问卷](https://www.numa_ultralytics.com/survey?utm_source=github&utm_medium=social&utm_campaign=Survey) 向我们提供您体验的反馈。感谢所有贡献者 🙏！

<!-- SVG image from https://opencollective.com/numa_ultralytics/contributors.svg?width=990 -->
...
numa_ultralytics 提供两种许可选项以适应各种用例：

- **AGPL-3.0 许可**：这是一个 [OSI 批准](https://opensource.org/license) 的开源许可，适合学生和爱好者，促进开放协作和知识共享。有关详细信息，请参阅 [LICENSE](https://github.com/numa_ultralytics/numa_ultralytics/blob/main/LICENSE) 文件。
- **企业许可**：专为商业使用设计，此许可允许将 numa_ultralytics 软件和 AI 模型无缝集成到商业产品和服务中，无需满足 AGPL-3.0 的开源要求。如果您的场景涉及将我们的解决方案嵌入到商业产品，请通过 [numa_ultralytics Licensing](https://www.numa_ultralytics.com/license) 联系我们。

## <div align="center">联系</div>

如需 numa_ultralytics 的错误报告和功能请求，请访问 [GitHub Issues](https://github.com/numa_ultralytics/numa_ultralytics/issues)。成为 numa_ultralytics [Discord](https://discord.com/invite/numa_ultralytics)、[Reddit](https://www.reddit.com/r/numa_ultralytics/) 或 [论坛](https://community.numa_ultralytics.com/) 的成员，提出问题、分享项目、探讨学习讨论，或寻求所有 numa_ultralytics 相关的帮助！
