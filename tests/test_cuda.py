...
from numa_ultralytics.utils import ASSETS, WEIGHTS_DIR
...
@pytest.mark.slow
@pytest.mark.skipif(True, reason="CUDA export tests disabled pending additional numa_ultralytics GPU server availability")
@pytest.mark.skipif(not CUDA_IS_AVAILABLE, reason="CUDA is not available")
